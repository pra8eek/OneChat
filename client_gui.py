...
msg_list = tkinter.Text(messages_frame, state='disabled', height=15,
                        width=50, yscrollcommand=scrollbar.set, font=('Times New Roman', 16))
...
entry_field = tkinter.Entry(
    frame1, textvariable=my_msg, borderwidth=0, highlightthickness=0, width=30)
